    ...
    <div className="grid gap-6">
      ...
      <section className="grid gap-2 rounded-lg border border-primary/20 bg-primary/5 p-5">
        ...
        <p className="text-xs text-muted-foreground">
          Общий лимит покрытия гарантии на площадку — {formatMoney(GUARANTEE_RESERVE_LIMIT)}. Резерв
          занимают деньги, уже переведённые мебельщикам по идущим сделкам; когда их сумма достигает
          лимита, отправка новых сделок временно приостанавливается.
        </p>
      </section>
